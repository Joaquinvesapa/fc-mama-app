      ...
      <div className="flex justify-center">
        ...
        width={'65%'}>
          <div className='rounded-xl'>
            <img className='rounded-xl' src='../public/fotos/img2.jpeg'></img>
          </div>
          <div className='rounded-xl'>
            <img className='rounded-xl' src='../public/fotos/img1.jpeg'></img>
          </div>
          <div className='rounded-xl'>
            <img className='rounded-xl' src='../public/fotos/img3.jpeg'></img>
          </div >
          <div className='rounded-xl'>
            <img className='rounded-xl'src='../public/fotos/img4.jpeg'></img>
          </div>
        </Carousel>
        <div>
        ...
        <div className='flex space-x-10 justify-center m-10 '>
          ...
          <img  src="../public/tarjetas/tarjeta-conciert.png" alt="" />
          </div>
          <div className='flex space-x-10 justify-center'>
          <img  src="../public/tarjetas/tarjetas-desayuno.png" alt="" />        
          </div>
        </div>
